 ...
 *
 */
#ifndef _ARCH_ARM_MACH_MSM_HTC_ACOUSTIC_7X27_H_
#define _ARCH_ARM_MACH_MSM_HTC_ACOUSTIC_7X27_H_
#define PROPERTY_VALUE_MAX  92

struct acoustic_tables {
	char acoustic[PROPERTY_VALUE_MAX];
	char acoustic_wb[PROPERTY_VALUE_MAX];
