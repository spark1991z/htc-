...
static struct mipi_dsi_phy_ctrl mipi_dsi_orise_panel_phy_ctrl = {
...
static int __init mipi_video_orise_wvga_pt_init(void)
{
	int ret;

	if (msm_fb_detect_client("mipi_video_orise_wvga"))
		return 0;
	MSM_FB_INFO("panel: mipi_video_orise_wvga\n");
	...
	pinfo.mipi.dsi_phy_db = &mipi_dsi_orise_panel_phy_ctrl;
...
module_init(mipi_video_orise_wvga_pt_init);
